/**
 * This file holds SGEOBIZ SEO plugin's JS code for SGEOBIZ term slug fetching and caching.
...
/**
 * Holds sgeobizTermSlugs values in an object to avoid polluting global namespace.
 *
 ...
 * @constructor
 */
window.sgeobizTermSlugs = function () {
	...
	function fetch( termId, taxonomy ) {
		...
		return new Promise( ( resolve, reject ) => {
			...
			wp.ajax.send(
				...
				store( sgeobiz.convertJSONResponse( response ), taxonomy );
				resolve();
			} ).fail( reject );
		} );
	}
