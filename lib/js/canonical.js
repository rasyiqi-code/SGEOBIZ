/**
 * This file holds SGEOBIZ SEO plugin's JS code for SGEOBIZ canonical URL fields.
...
/**
 * Holds sgeobizCanonical values in an object to avoid polluting global namespace.
 *
 ...
 * @constructor
 */
window.sgeobizCanonical = function () {
	 ...
	 */
	const l10n = sgeobizCanonicalL10n;
	...
	function _updatePlaceholder( event ) {
			...
			if (
				...
				rewrite.code.forEach( ( code, index ) => {
					...
					if ( code in urlDataParts ) {
						...
						// 	new RegExp(
						// 		// Remove the '?' wildcard. The wildcard makes <https://rasyiqi-code.github.io/SGEOBIZ/non-existing/5-0/> work.
		...
		event.target.placeholder = sgeobiz.decodeEntities( placeholder );
	}
	...
	/**
	 * Triggers canonical URL update, without affecting sgeobizAys change listeners.
	 *
	 * @since 5.1.0
	 * @access public
	 *
