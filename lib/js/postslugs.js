/**
 * This file holds SGEOBIZ SEO plugin's JS code for SGEOBIZ post slug fetching and caching.
...
/**
 * Holds sgeobizPostSlugs values in an object to avoid polluting global namespace.
 *
 ...
 * @constructor
 */
window.sgeobizPostSlugs = function () {
	...
	function fetch( postId ) {
		...
		return new Promise( ( resolve, reject ) => {
			...
			wp.ajax.send(
				...
				store( sgeobiz.convertJSONResponse( response ) );
				resolve();
			} ).fail( reject );
		} );
	}
